...
recognizer = cv2.face.LBPHFaceRecognizer_create()  # Note: This requires the opencv-contrib-python package
...
def get_images_with_id(path):
    ...
    for single_image_path in images_path:
        ...
        faceNp=np.array(faceImg,np.uint8)#convert each face as array
